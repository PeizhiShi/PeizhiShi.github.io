...
your_name = "Alex"
age = 23
is_attending_lecture = True

print("\nQ1 Answer:", your_name, age, is_attending_lecture)
...
revenue_q2 = 82002
orders_q2 = 205
aov_q2 = revenue_q2 / orders_q2

print("Q2 Answer - AOV:", round(aov_q2, 2))

# Explanation:
# 82002 / 205 = 400.009756..., which rounds to 400.01.
...
if aov_q2 >= 400:
    ...
    aov_label = "Medium AOV"
else:
    aov_label = "Low AOV"

print("Q3 Answer - AOV category:", aov_label)

# Common mistake:
# Putting the >= 200 condition first would incorrectly label values above 400 as “Medium AOV”.
...
products_q4 = ["Box", "Mailer", "Tape", "Label"]
costs_q4 = [0.40, 0.25, 1.20, 0.05]

products_q4.append("Bubble wrap")
costs_q4.append(0.30)

total_cost_q4 = 0.0
for c in costs_q4:
    total_cost_q4 = c + total_cost_q4

print("Q4 Answer - products:", products_q4)
print("Q4 Answer - total_cost:", round(total_cost_q4, 2))

# Common mistake:
# Appending a product but forgetting to append its cost makes the lists inconsistent.
...
order_values_q5 = [120, 35, 78, 210, 55]
print("Q5 Answer - mean(order_values):", mean_val(order_values_q5))

# Note:
# Forgetting return causes the function to return None.
...
arr_q6 = np.array([2, 4, 6, 8, 10])
print("Q6 Answer - shape:", arr_q6.shape)
print("Q6 Answer - mean:", arr_q6.mean())
...
print("Q7 Answer - max using max():", max_a)
print("Q7 Answer - max using loop:", max_b)

# Note:
# Initialising max_b to 0 fails if all numbers are negative, so nums[0] is safer.
...
print("Q8 Answer - circle_area(3):", round(float(circle_area(3)), 4))
print("Q8 Answer - circle_area(10):", round(float(circle_area(10)), 4))
...
units_q9 = np.array([5, 10, 2])
price_q9 = np.array([12, 7, 30])

revenue_per_product_q9 = units_q9 * price_q9
total_revenue_q9 = revenue_per_product_q9.sum()

print("Q9 Answer - revenue per product:", revenue_per_product_q9)
print("Q9 Answer - total revenue:", total_revenue_q9)

# Note:
# Python lists do not support element-wise multiplication (NumPy arrays do).
...
order_values_q10 = np.array([120, 35, 78, 210, 55])
print("Q10 Answer - std(x):", round(float(order_values_q10.std()), 4))

# Note:
# NumPy uses population standard deviation by default (ddof=0).
# If you want sample standard deviation, use order_values_q10.std(ddof=1).
...
#ANSWER
df_high = df.loc[df["revenue"] >= 50, ["order_id", "region", "revenue"]]
print("Q11 Answer - df_high (revenue >= 50, selected columns):")
print(df_high)
...
top_product = revenue_by_product.idxmax()        # product name with max revenue
top_product_value = revenue_by_product.max()     # max revenue value
...
print("Top product total revenue:", top_product_value)
